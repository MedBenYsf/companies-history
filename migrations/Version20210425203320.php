 ...
 */
final class Version20210425203320 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE addresses (id INT AUTO_INCREMENT NOT NULL, channel_number INT NOT NULL, channel_name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postal_code INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE versions (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, address_id INT NOT NULL, name VARCHAR(255) NOT NULL, registration_city VARCHAR(255) NOT NULL, registration_date DATETIME NOT NULL, capital DOUBLE PRECISION NOT NULL, INDEX IDX_19DC40D2979B1AD6 (company_id), UNIQUE INDEX UNIQ_19DC40D2F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE versions ADD CONSTRAINT FK_19DC40D2F5B7AF75 FOREIGN KEY (address_id) REFERENCES addresses (id)');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE versions DROP FOREIGN KEY FK_19DC40D2F5B7AF75');
